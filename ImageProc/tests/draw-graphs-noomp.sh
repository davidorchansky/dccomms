...
a=($ut01 $ut02 $ut03 $ut04 $ut05 $ut06 $ut07 $ut08 $ut09)
	...
	gnuplot -e "maxv=$maxv; ttotal=$ttotal; inputfile=\"$plotDataFile\"; imagen=\"$(basename $i)-$per\\%\"; sigma=$sigma; tfiltro=$filterSize; ut=$uthold; lt=$lthold; angles=$angles; outputfile=\"$histogramFile\"; arch=\"$arch\"; schedule=\"no\"; chunkSize=0" plotData
