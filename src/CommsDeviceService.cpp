...
CommsDeviceService::CommsDeviceService(int _type,
                                       const DataLinkFrame::fcsType &_fcsType,
                                       int maxframesize)
    : service(this) {
...
CommsDeviceService::ServiceMessage::ServiceMessage() { buffer = NULL; }
...
void CommsDeviceService::ServiceMessage::BuildFrameMsg(
    const DataLinkFramePtr &dlf) {
...
DataLinkFramePtr CommsDeviceService::ServiceMessage::GetDataLinkFrame(
    const DataLinkFrame::fcsType &_fcsType) const {
