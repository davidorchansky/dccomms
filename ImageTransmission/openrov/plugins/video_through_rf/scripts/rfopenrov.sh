#!/bin/bash
#
# This script is based on https://gist.github.com/peterhost/715255 with adaptions mentioned in the comments
# https://gist.github.com/peterhost/715255/#comment-944042
#
# Modified by OpenROV Inc. Dominik Fretz <dominik@openrov.com>
#
# ------------------------------------------------------------------------------ 
...
# Default-Stop:      0 1 6
# Short-Description: Starts the NodeJs server to control the OpenROV
# Description:       Starts the OpenROV cockpit on port 8080
### END INIT INFO

# Author:OpenROV Inc. Dominik Fretz <dominik@openrov.com>
#
...
DAEMON_ARGS="/opt/openrov/rf-src/app.js"               # path to your node.js server/app
                                            # NB: don't use ~/ in path

DESC="OpenROV NodeJS server"                  # whatever fancy description you like
